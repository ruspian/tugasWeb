...
switch($aksi){
  ...
  default:
    ...
    $tampil=mysqli_query($conn, "SELECT * FROM templates ORDER BY id_templates DESC LIMIT $posisi,$batas");
    ...
    echo "</table>";
    $jmldata=mysqli_num_rows(mysqli_query($conn, "SELECT * FROM templates"));
